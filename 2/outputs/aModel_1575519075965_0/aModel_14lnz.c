...
const char *aModel_linear_model_datarecovery_frame()
{
  ...
  "\n"
  "  Real 'x_Mass.s' = x[1];\n""  Real 'x_Mass.v' = x[2];\n"
  "  Real 'z_Mass.a' = z[1];\n""  Real 'z_Mass.flange_a.s' = z[2];\n""  Real 'z_Mass.flange_b.f' = z[3];\n""  Real 'z_Mass.flange_b.s' = z[4];\n""  Real 'z_Spring.f' = z[5];\n""  Real 'z_Spring.s_rel' = z[6];\n"
  "equation\n  der(x) = A * x + B * u;\n  y = C * x + D * u;\n  z = Cz * x + Dz * u;\nend linear_aModel;\n";
}
#if defined(__cplusplus)
}
